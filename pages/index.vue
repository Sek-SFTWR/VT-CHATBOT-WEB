<template>
  <div class="flex flex-col bg-gray-50 h-full p-4">
    <!-- Chat box -->
    <div
    ...
    <div
      class="p-4 border-t border-gray-300 flex items-center space-x-4 bg-white h-[calc(10vh)]"
    >
      <input
        v-model="userMessage"
...
const sendMessage = async () => {
  ...
  try {
    // Send message to API
    const response = await fetchData("/api/chatbot", {
      method: "POST",
